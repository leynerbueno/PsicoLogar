...
INSERT INTO `psicologar`.`psicologo` (`nome`, `data_de_nascimento`, `genero`, `email`, `senha`, `endereco`, `crp`) VALUES ('Admin Psicologo', '1994-03-21', 'Feminino', 'admin@admin.com', '$2a$10$ABc5yVx.AwfDVK9QHJ7so.aiTTFSFy/sEmmpTHn.ohoVkKwWnguUu', 'Rua teste 02', 'admin');

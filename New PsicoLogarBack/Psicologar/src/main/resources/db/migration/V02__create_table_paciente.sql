...
INSERT INTO `psicologar`.`paciente` (`nome`, `data_de_nascimento`, `genero`, `email`, `senha`, `endereco`, `data_da_consulta`, `psicologo_id`) VALUES ('Admin', '1994-03-21', 'Masculino', 'adminpacinete@admin.com', '$2a$10$8wGN2qvSibIxK.I3LCuo2OlxyJ7Ia1merzW5zmw8ztjbmzI6vgpHa', 'Rua teste 02','2020-06-13','4');